...
type TokenContextType = {
  firstToken: object,
  secondToken: object,
  setFirstToken: (value: object) => void,
  setSecondToken: (value: object) => void,
...
const App = (props: { location: { hash: string; pathname: string } }) => {
  ...
  return (
    <TokenContext.Provider value={{firstToken: firstToken, setFirstToken, secondToken, setSecondToken}}>
